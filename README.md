...
В viewer можно включить панель FPS и draw calls:

- кнопка **«Метрики»** в панели инструментов;
- или параметр URL: `&stats=1`

Пример:
`viewer.html?client=tbank-khl&project=april-2026-game&stats=1`

Метрики доступны только в viewer (не при прямом открытии `projects/.../index.html`).
